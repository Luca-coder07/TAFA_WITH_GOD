...
void InitLogoScreen(void)
{
    ...
    logoPositionX = screen_width/2 - 128;
    logoPositionY = screen_height/2 - 128;
...
void DrawLogoScreen(void)
{
    ...
    else if (state == 3)    // Draw "raylib" text-write animation + "powered by"
    {
        ...
        DrawText(TextSubtext("raylib", 0, lettersCount), screen_width/2 - 44, screen_height/2 + 48, 50, Fade(BLACK, alpha));
